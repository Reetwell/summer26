...
- **Plan-control polish** — engine shipped (`e6224a2`); remaining: DESIGN's styling commit,
  active-session page needs `app.js` wiring, confirm in-session *swap* (reorder ≠ swap),
  reschedule day-picker (currently a `prompt()`)
